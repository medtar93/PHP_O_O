...
try{
    ...
    $resultat = $pdo -> prepare("SELECT * FROM employes WHERE prenom = :prenom AND nom = :nom");
        ...
        $resultat -> binParam (':prenom', $prenom, PDO :: PARAM_STR);
        $resultat -> binParam (':nom', $nom, PDO :: PARAM_STR);
        $resultat -> binParam (':telephone', $telephone, PDO :: PARAM_INT);
        $resultat -> execute ();
        ...
        //Combien de résultat à la rêquete : PLUSIEURS ===> Boucle      while($employes = $resultat -> fetch(PDO::FETCH_ASSOC)) {
        ...
        //Combien de résultat à la rêquete : PLUSIEURS ===> Boucle ou fetchAll      $employes = $resultat -> fetchAll(PDO::FETCH_ASSOC);      echo '<pre>';
